...
import { getContactUs, deleteContactUs } from '../../store/action/contactUsAction';

import {
  DELETE_CONTACTUS_RESET,
} from '../../store/slice/contactUsSlice/contactUsSlice';
...
const ContactUs = () => {
  ...
  const { allContactUs, loading: allContactUsLoader } = useSelector((state) => {
    return state.allContactUs;
  });
  ...
  const deleteData = (id) => {
    ...
    dispatch(deleteContactUs(payload));
  };
            ...
            <Paper>
              <TableContainer component={Paper}>
                <Table stickyHeader>
                  ...
                  <TableBody>
                    {allContactUs?.items?.map((row, index) => {
                      let start = moment(row.createdAt).format("ddd DD MMM YY LT");
                      return (
                        <TableRow
                          key={row._id}
                        ...
                        >
                          ...
                          <TableCell align="center">{row?.read ?
                          ...
                          <TableCell align="center">
                            <IconButton
                              onClick={() => navigate(`/contactUs/reponse/${row?._id}`)}
                            >
              ...
              <TablePagination
                ...
                component="div"
                count={parseInt(allContactUs?.count) || 0}
                rowsPerPage={rowsPerPage}
                page={!parseInt(allContactUs?.count) || parseInt(allContactUs?.count) <= 0 ? 0 : page}
